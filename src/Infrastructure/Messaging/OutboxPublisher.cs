...
internal sealed class OutboxPublisher : BackgroundService
{
    ...
    private static readonly Dictionary<string, Type> EventTypeMap = new()
    {
        ...
        [nameof(CommentCreated)]                 = typeof(ForumCommentCreatedEvent),
        [nameof(MembershipInvited)]              = typeof(ForumMembershipInvitedEvent),
        [nameof(MembershipJoined)]               = typeof(ForumMembershipJoinedEvent),
        [nameof(ModeratorAppointed)]             = typeof(ForumModeratorAppointedEvent),
        [nameof(ModeratorRemoved)]               = typeof(ForumModeratorRemovedEvent),
        [nameof(UserBanned)]                     = typeof(ForumUserBannedEvent),
        [nameof(UserUnbanned)]                   = typeof(ForumUserUnbannedEvent),
        [nameof(ThreadLocked)]                   = typeof(ForumThreadLockedEvent),
        [nameof(ThreadPinned)]                   = typeof(ForumThreadPinnedEvent),
        [nameof(CommunityOwnershipTransferred)]  = typeof(ForumCommunityOwnershipTransferredEvent),
    ...
    private async Task ProcessOutboxAsync(CancellationToken cancellationToken)
    {
        ...
        var messages = await dbContext.OutboxMessages
            .FromSqlRaw("""
                SELECT * FROM forum.outbox_messages
